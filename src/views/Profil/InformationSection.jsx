...
const TABLE_HEAD = ["Nama Dusun", "Jumlah RW", "Jumlah RT"];

const TABLE_ROWS_ADMINISTRATIF = [
  {
    name: "Dusun I",
    rw: "5",
    rt: "28",
...
const TABLE_ROWS_BATAS = [
  ...
  },
  {
    ...
    separator: ":",
    value: "Desa Dayeuhkolot",
  },
  {
    name: "Sebelah Timur",
    separator: ":",
    value: "Desa Bojongsoang Kecamatan Bojongsoang",
  },
  {
    name: "Sebelah Barat",
    separator: ":",
    value: "Kelurahan Pasawahan",
  },
];
  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <div className="grid grid-cols-2 place-items-center relative">
        ...
        <div
          className="hidden absolute top-2/4 -start-20 transform -translate-y-2/4 -translate-x-40 md:block lg:-translate-x-80"
          aria-hidden="true"
        >
          <svg
        ...
        <div>
          <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <Typography variant="paragraph" color="gray" className="mt-1">
              Pembagian geografis Desa Citeureup
            </Typography>
          </div>
          <Card color="transparent" shadow={false}>
            <table className="w-full min-w-max table-auto text-left">
              ...
              <tbody>
                {TABLE_ROWS_ADMINISTRATIF.map(({ name, rt, rw }, index) => {
                  const isLast = index === TABLE_ROWS_ADMINISTRATIF.length - 1;
                  const classes = isLast
                    ? "p-4"
                    : "p-4 border-b border-navy-800";
        ...
        <div>
          <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <Typography variant="paragraph" color="gray" className="mt-1">
              Daerah sekitar Desa Citeureup
            </Typography>
          </div>
          <Card color="transparent" shadow={false}>
            <table className="w-full min-w-max table-auto text-left">
              <tbody>
                {TABLE_ROWS_BATAS.map(({ name, separator, value }, index) => {
                  const isLast = index === TABLE_ROWS_BATAS.length - 1;
                  const classes = isLast
                    ? "p-4"
                    : "p-4 border-b border-navy-800";
