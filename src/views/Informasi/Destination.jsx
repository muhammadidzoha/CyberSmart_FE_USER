    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="grid grid-cols-3 gap-5 place-items-center relative">
        ...
        {data.results.map((destination) => (
          <Card key={destination.destination_id} className="mt-6 w-96 group">
            ...
            <CardBody>
              ...
              <Typography variant="paragraph" className="font-normal">
                <pre className="truncate font-sans">
            ...
            <CardFooter className="pt-0">
              <div className="flex justify-between items-center gap-5">
                ...
                <Typography variant="small" color="gray">
                  {format(new Date(destination.created_at), "dd MMMM yyyy")}
                </Typography>
              </div>
              <Typography
                as="a"
                href={`./potensi-desa/${destination.destination_id}`}
              >
