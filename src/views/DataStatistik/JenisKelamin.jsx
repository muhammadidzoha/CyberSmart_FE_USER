...
import { jeniskelaminChart } from "./variabels/chart";

Highcharts3D(Highcharts);

const TABLE_ROWS = jeniskelaminChart.series[0].data.map((dataPoint) => ({
  name: dataPoint.name,
  y: dataPoint.y,
...
const JenisKelamin = () => {
  return (
    <div>
      <HighchartsReact highcharts={Highcharts} options={jeniskelaminChart} />
