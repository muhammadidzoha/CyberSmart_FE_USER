...
import { pekerjaanChart } from "./variabels/chart";

Highcharts3D(Highcharts);

const TABLE_ROWS = pekerjaanChart.series[0].data.map((dataPoint) => ({
  name: dataPoint.name,
  y: dataPoint.y,
...
const Pekerjaan = () => {
  return (
    <div>
      <HighchartsReact highcharts={Highcharts} options={pekerjaanChart} />
