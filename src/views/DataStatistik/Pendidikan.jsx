...
import { pendidikanChart } from "./variabels/chart";

Highcharts3D(Highcharts);

const TABLE_ROWS = pendidikanChart.series[0].data.map((dataPoint) => ({
  name: dataPoint.name,
  y: dataPoint.y,
...
const Pendidikan = () => {
  return (
    <div>
      <HighchartsReact highcharts={Highcharts} options={pendidikanChart} />
